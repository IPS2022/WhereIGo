...
| 3주차 (5/16 ~ 5/22)| <li>크롤링 내용 firebase에 올리기</li><li>크롤링 내용 앱으로 불러오기</li><li>지도 검색창 layout 수정본 적용</li><li>메인페이지 특정 부위 클릭시 부위에 해당하는 질병리스트 다이얼로그창에 띄우기 완료</li> | <li>경민</li> <li>경민</li><li>진영</li><li>진영</li> |
